...
const initialFeedbacks = [
  ...
  { feedbackId: 4, donorId: "D004", feedback: "Comfortable environment." },
  {
    feedbackId: 5,
    donorId: "D005",
    feedback: "Smooth process to schedule an appointment.",
  },
  {
    feedbackId: 6,
    donorId: "D006",
    feedback: "Great way to save time for queueing up.",
  },
];
          ...
          {feedbacks.map((feedback) => (
            <tr key={feedback.feedbackId} className={styles.tableRow}>
              ...
              <td className={styles.tableButtonCell}>
                <img
                  src="/DeleteRow.png" // Update the path to match your image file location
                  alt="Delete feedback"
                  className= {styles.deleteIcon}
                  onClick={() => showPopup(feedback.feedbackId)} // Retain the onClick functionality
                />
              </td>
            </tr>
          ))}
